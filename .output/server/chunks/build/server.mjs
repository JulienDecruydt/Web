import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, useSlots, h, Fragment, ref, inject, Suspense, createApp, reactive, computed, toRaw, provide, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, watch, mergeProps, getCurrentScope, onScopeDispose, useSSRContext } from 'vue';
import { k as klona, i as defuFn, e as createError$1, j as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch$1, o as baseURL, q as defu, r as createHooks, t as executeAsync, v as toRouteMatcher, x as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B_c8Rc7w.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-FGRstlrA.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CpJ1kZtX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DFt9P3WA.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAppConfig as d, entry$1 as default, asyncDataDefaults as e, createError as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
