...
import { f as commands, c as cwdArgs, s as setupGlobalConsole, g as checkEngines } from './cli.BkxMuIgF.mjs';
import nodeCrypto from 'node:crypto';
import { resolve } from 'node:path';
import { provider } from 'std-env';
import { d as description, v as version, n as name } from './cli.COenF99x.mjs';
